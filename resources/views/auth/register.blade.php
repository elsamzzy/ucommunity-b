        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <div class="mb-4">
                        <h3 style="font-family: 'Comic Sans MS',serif ">Register</h3>
                    </div>
                </div>
            </div>
            <div class="row">
                        ...
                        <div class="col-md-8">
                            <form class="mb-3" method="post" autocomplete="off">
                                ...
                                <div class="form-group first">
                                    ...
                                    <input type="text" class="form-control @error('address') is-invalid @enderror" required  name="address" value="{{old('address')}}" id="address" autocomplete="off">
                                    @error('address')
                                    <div class="text-danger">
                                        {{ $message }}
                                    </div>
                            ...
                            <span class="ml-auto mt-3">Have an account? Login <a href="{{route('login')}}" >Here</a></span>
                        </div>
                    </div>
