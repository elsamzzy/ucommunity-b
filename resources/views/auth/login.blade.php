                        ...
                        <div class="col-md-8">
                            ...
                            <form class="mb-3" method="post" autocomplete="off">
                                ...
                                <div class="form-group first">
                                    ...
                                    <input type="email" class="form-control @error('email') is-invalid @enderror" autocomplete="off" name="email" value="{{old('email')}}" id="email">
                                    @error('email')
                            ...
                            <span class="ml-auto mt-3">Register for an account <a href="{{route('register')}}" >Here</a></span>
                        </div>
                    </div>
