                        ...
                        <div class="au-breadcrumb-content">
                            <div class="au-breadcrumb-left">
                                ...
                                <ul class="list-unstyled list-inline au-breadcrumb__list">
                                    ...
                                    <li class="list-inline-item">{{ __('Tax Code') }}</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="login-form">
                        <form action="{{ route('tax') }}" method="post">
                            ...
                            <div class="form-group">
                                <label for="code">{{{ __('Tax Code') }}}</label>
                                <input class="au-input au-input--full @error('code') is-invalid @enderror" type="text" name="code" value="{{ old('code') }}" placeholder="Tax Code" required>
                                @if(session('code'))
